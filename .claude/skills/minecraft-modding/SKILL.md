...
- Padrões de registro/evento NeoForge: `~/.claude/skills/minecraft-modding/references/neoforge-api.md`
- Templates de JSON (blockstate, model, loot table, recipe, tags) — só relevante se um mod futuro
  registrar blocks/items de verdade: `~/.claude/skills/minecraft-modding/references/common-patterns.md`
