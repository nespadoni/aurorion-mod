 ...
 * lista pronta quando o altar manda. Se um cliente mandar um id de casa que nao existe aqui, a
...
public final class HouseCatalog {
    ...
    private static final DatapackRegistry<House> REGISTRY =
            new DatapackRegistry<>(DIRECTORY, AurorionEthereal.LOGGER, House::codec, ORDER);
