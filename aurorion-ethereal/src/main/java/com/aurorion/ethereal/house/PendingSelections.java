...
/**
 * Quem tem a grade de casas aberta, e em qual altar.
 *
 * <p>So o caminho de escolha direta passa por aqui (o que a config {@code ceremonyRequired = false}
 * liga). A Cerimonia de Vinculacao nao precisa disto: la o jogador nao aponta casa nenhuma, e cada
 * resposta e validada contra o estado da propria cerimonia.
 *
...
public final class PendingSelections {
    ...
    public static boolean consume(ServerPlayer player) {
        ...
        return player.level().getBlockState(pending.altar()).is(EtherealTags.HOUSE_ALTARS);
    }
