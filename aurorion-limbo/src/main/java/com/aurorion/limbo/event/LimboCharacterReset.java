...
/**
 * O exilio, o prazo, o epilogo pendente e o espolio da ultima morte morrem com o personagem que os
 * viveu.
 *
...
public final class LimboCharacterReset {
    ...
    public static void onReset(CharacterResetEvent event) {
        ...
        // O espolio era do personagem que morreu. Chamar de volta o inventario dele para a
        // identidade nova desfaria o reset de progressao.
        DeathRecall.clear(event.server(), event.previousCharacterId());
    }
}
