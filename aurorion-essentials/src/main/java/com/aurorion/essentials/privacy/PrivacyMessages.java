 ...
 * (conquistas). Quando escondida, a mensagem so vai para quem tem OP (nivel 2+)
 * em vez do broadcast normal do {@link PlayerList} — o mixin que chama isto redireciona
